...
class AutoGumaTest {
	...
	@CsvSource({
			...
			"Marka, 15, 200, 70, Marka, 15, 200, 70, true ", "Marka, 15, 200, 70, Markaa, 15, 200, 70, false ",
			"Marka, 17, 200, 70, Marka, 15, 200, 80, false ", "Marka, 15, 201, 70, Marka, 15, 200, 80, false ",
			"Marka, 15, 200, 70, Marka, 15, 200, 80, false ", })
	void testEqualsObject(String markaPrvog, int precnikPrvog, int sirinaPrvog, int visinaPrvog, String markaDrugog,
			int precnikDrugog, int sirinaDrugog, int visinaDrugog, boolean result) {
